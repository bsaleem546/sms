    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center text-right">
            <div class="d-flex justify-content-end align-items-center">
                ...
                <a href="{{ route('students.index') }}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Back</a>
            </div>
        </div>
    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="text-right">
                                @if($data->admission->student_pic !== null)
                                    <img src="{{ url('public/uploads/students/'.$data->admission->student_pic) }}" alt="" style="height: 150px">
                                @endif
                            </div>
                        </div>
                    </div>
