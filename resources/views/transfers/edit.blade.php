        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-body">
                    ...
                    {!! Form::model($data, array('route' => ['transfers.update', $data->id],'method'=>'PATCH', 'class' => 'form-material m-t-40 create', 'enctype' => 'multipart/form-data')) !!}
                                ...
                                <div class="col-sm-12 validate">
                                    <select name="admission_id" class="form-control" required>
                                        ...
                                        @foreach($admissions as $a)
                                            <option value="{{ $a->id }}" {{ $a->id == $data->admission_id ? 'selected' : '' }}>
                                                {{ $a->id." - ".$a->student_name." - ".$a->_class->name." - ".$a->_class->section->name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" name="school_name" class="form-control" required placeholder="School Name" value="{{ $data->school_name }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" name="class_name" class="form-control" required placeholder="Class Name" value="{{ $data->class_name }}">
                                </div>
                            </div>
                        </div>
