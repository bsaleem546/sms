                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="text-center">
                                    <img id="image_uploaded" src="{{ asset('uploads/students/' . $data->student_pic) }}"
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" name="religion" required placeholder="Religion"
                                        class="form-control" value="{{ $data->religion }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" placeholder="Extra Note" name="extra_note"
                                        class="form-control" value="{{ $data->extra_note }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" required placeholder="GR NO" name="gr_no"
                                        class="form-control" value="{{ $data->gr_no }}">
                                </div>
                            </div>
                            {{--                            <div class="col-md-4"> --}}
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" required placeholder="Admission Fees" name="admission_fees"
                                        value="{{ $ad_fee }}" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" required placeholder="Admission Fees" name="tuition_fees"
                                        value="{{ $tt_fee }}" class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" required placeholder="Father Name" name="father_name"
                                        class="form-control" value="{{ $data->father_name }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" placeholder="Father Phone" name="father_phone"
                                        class="form-control" value="{{ $data->father_phone }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" placeholder="Father Occupation" name="father_occ"
                                        class="form-control" value="{{ $data->father_occ }}">
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" required placeholder="Mother Name" name="mother_name"
                                        class="form-control" value="{{ $data->mother_name }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" required placeholder="Mother Phone" name="mother_phone"
                                        class="form-control" value="{{ $data->mother_phone }}">
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="col-sm-12 validate">
                                    <input type="text" required placeholder="Mother Occupation" name="mother_occ"
                                        class="form-control" value="{{ $data->mother_occ }}">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="row d-flex">
                                    ...
                                    <input type="radio" name="is_trans" value="1" class="ml-4 mr-4"
