                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12 validate">
                                    {!! Form::number('deduction_days', null, array('placeholder' => 'Salary','class' => 'form-control', 'required')) !!}
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12 validate">
{{--                                    @dd($data)--}}
                                    {!! Form::text('deduction', null, array('placeholder' => 'Deduction','class' => 'form-control', 'required','value' => '{{$data->staff_id}}')) !!}
                                </div>
                            </div>
                            <div class="col-md-6">
