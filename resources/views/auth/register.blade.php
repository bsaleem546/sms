...
@section('content')
    ...
    <form class="form-horizontal form-material text-center" id="login-reg" action="{{ route('register') }}" method="post">
        ...
        <a href="javascript:void(0)" class="db">
            <img src="{{ url('public/assets/images/logo-icon.png') }}" alt="Home" />
            <br/>
            <img src="{{ url('public/assets/images/logo-text.png') }}" alt="Home" />
        </a>
        ...
        <div class="form-group">
            <div class="col-xs-12">
                <input id="password-confirm" type="password" class="form-control"
                       name="password_confirmation" required autocomplete="new-password" placeholder="Confrim Password">
            </div>
        </div>
